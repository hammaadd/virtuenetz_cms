...
class MonacoEditor extends VueComponentBase
{
    ...
    {
        $this->addJs('vendor/monaco@0.20.0/min/vs/loader.js');
    ...
    protected function prepareVars()
    {
        ...
        $configuration = [
            'vendorPath' => Url::asset('/modules/backend/vuecomponents/monacoeditor/assets/vendor/monaco@0.20.0/min'),
        ...
        elseif ($wordWrap === 'fluid') {
            $configuration['wordWrap'] = 'bounded';
        }
        else {
